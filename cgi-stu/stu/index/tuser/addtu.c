...
int cgiMain()
{
  ...
  //char president[10]="\0";
	...
	strcpy(sql, "create table tuser(tno varchar(32) primary key, password varchar(32) not null ,fl varchar(8),foreign key (tno) references teacher(tno))character set = utf8;");
	...
	sprintf(sql, "insert into tuser values('%s', '%s','1')", tno,password);
